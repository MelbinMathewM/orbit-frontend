...
import { activityItems, dayTourLocationItems, methodItems, vehicleItems } from "../../../constants/modal-items";
...
export default function DayTourEnquiryForm() {
    ...
    return (
        ...
        >
            ...
            >
                <BookingHeader title="Day Tour Enquiry Form"/>
                <View className="px-5 space-y-3">
                    ...
                    <CustomTextInput label="Time" value={form.time} onChangeText={(t) => handleChange("time", t)} />
                    ...
                    <CustomTextInput label="Budget" value={form.budget as string} onChangeText={(t) => handleChange("budget", t)} />
